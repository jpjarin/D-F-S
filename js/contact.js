      ...
      $.ajax({
        ...
        error: function() {
          ...
          $('#success > .alert-danger').html("<a class='close' data-dismiss='alert' aria-hidden='true'>&times;")
            .append("</a>");
          $('#success > .alert-danger').append($("<strong>").text("Sorry " + firstName + ", it seems that my mail server is not responding. You can try again later or Email me via dalaineflowershop@gmail.com"));
